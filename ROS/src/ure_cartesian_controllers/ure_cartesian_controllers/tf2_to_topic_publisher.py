...
class TF2ToTopicPublisher(Node):
    """A ROS2 node that uses a TF2 transform listener to query the transform
    ...
    def __init__(self):
        ...
        self.from_frame = self.declare_parameter("from_frame", "base").get_parameter_value().string_value
        self.to_frame = self.declare_parameter("to_frame", "NON_EXISTING_FRAME").get_parameter_value().string_value
        self.topic_name = (
